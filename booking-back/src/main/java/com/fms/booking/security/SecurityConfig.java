package com.fms.booking.security;


import com.fms.booking.security.JWTFilter.JwtAuthenticationFilter;
import com.fms.booking.security.JWTFilter.JwtAuthorizationFilter;
...
////        http.authorizeHttpRequests().antMatchers( HttpMethod.GET,"/auth/**").hasRole("USER");
        http.authorizeHttpRequests().antMatchers("/booking/**").permitAll();
//
